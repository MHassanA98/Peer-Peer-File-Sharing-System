...
def testJoin(nodes,p):
	...
	for i in range(len(nodes)-1):
		# print("\n\nSucc:",nodes[i].successor, nodes[i].hasher(nodes[i].successor[0]+str(nodes[i].successor[1])), nodes[i].predecessor, nodes[i].hasher(nodes[i].predecessor[0]+str(nodes[i].predecessor[1])), nodes[i].key,"\n\n")
...
def printN(nodes):
	...
	for n in nodes:
		...
		print (n.predecessor, n.successor,n.secondSuccessor)
		print (n.files)
		print (n.backUpFiles)
